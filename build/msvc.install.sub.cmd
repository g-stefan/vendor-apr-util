...
xcopy /Y /S /E "temp\apr-util\bin\*.exe" "%INSTALL_PATH_BIN%\"
xcopy /Y /S /E "temp\apr-util\bin\*.dll" "%INSTALL_PATH_BIN%\"
...
xcopy /Y /S /E "temp\apr-util\bin\*.exe" "%INSTALL_PATH_DEV%\bin\"
xcopy /Y /S /E "temp\apr-util\bin\*.dll" "%INSTALL_PATH_DEV%\bin\"
xcopy /Y /S /E "temp\apr-util\include\" "%INSTALL_PATH_DEV%\include\"
copy /Y /B "temp\apr-util\lib\*.lib" "%INSTALL_PATH_DEV%\lib\*"
